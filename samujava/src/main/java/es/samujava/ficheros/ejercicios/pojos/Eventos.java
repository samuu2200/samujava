package es.samujava.ficheros.ejercicios.pojos;
...
public class Eventos {
    ...
    public Eventos(int id, String nombre, java.util.Date fecha2, String lugar, String descripcion, int duracion, double precio,
