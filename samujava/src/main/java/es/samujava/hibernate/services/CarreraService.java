package es.samujava.hibernate.services;

import java.util.ArrayList;
import java.util.List;

import es.samujava.hibernate.dao.CaballoDAO;
import es.samujava.hibernate.dao.CaballoDAOImpl;
import es.samujava.hibernate.dto.CaballoDTO;
import es.samujava.hibernate.entities.CaballoCarrera;
import es.samujava.hibernate.entities.Jinete;
import es.samujava.hibernate.exceptions.CaballoException;
...
public class CarreraService {
    ...
    public void insertarCaballo(CaballoDTO caballoDto) {
        ...
        Jinete jinete = new Jinete(caballoDto.getNombre(), caballoDto.getNacionalidadJinete());
        ...
        if (caballosDTO.size() >= 2) {
            ...
            do {
                for (CaballoDTO caballoDTO : caballosDTO) {
                    ...
                    System.out.println("Caballo " + caballoDTO.getNombre() + " lleva recorridos "
                            + caballoDTO.getAvance() + " metros");
